package com.ihsan.android.stockhawk.data.generated;
...
public class QuoteProvider extends ContentProvider {
  public static final String AUTHORITY = "com.ihsan.android.stockhawk.data.QuoteProvider";
  ...
  public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
    ...
    switch(MATCHER.match(uri)) {
      case QUOTES_CONTENT_URI: {
        ...
        Cursor cursor = builder.table("quotes")
